...
function naya_lite_about_page() {   ?>
	<div class="wrap" style="width:75%">
		...
		<div>
			...
			<p><?php _e( 'For further help, please visit our support page at:', 'naya-lite' ); ?> <a href="<?php echo esc_url( 'https://www.sampression.com/supports' ); ?>" target="_blank"><?php echo esc_url( 'https://www.sampression.com/supports' ); ?></a></p>
		</div>
		<div>
